...
1. [ ] Project scaffolding and local app bootstrap — initialize the Python + Streamlit project structure, dependency manifest, app entry point, and startup/health verification for the single-user demo. <!-- depends: none -->
