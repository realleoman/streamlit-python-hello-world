...
- [ ] Create the Streamlit page shell in `app.py` with a centered layout, a clear page title, and a single visible action button named `Click me` so the interaction remains deterministic and easy to extend.
