...
- [ ] Create the Python + Streamlit project manifest in `requirements.txt` with the `streamlit` dependency and a minimal setup that can be installed in a clean virtual environment.
